...
echo "###########################################################"
sudo eopkg it dmenu i3 dunst vim i3status i3lock feh flameshot picom light font-awesome-4 arandr fish zsh micro iw || error "Error: We couldn't download the packages."
